...
class BamlStreamClient:
    ...
    def ChatWithLLM(
        ...
        messages: List[types.ChatMessage],available_tools: List[types.MCPTool],
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[Optional[Union[partial_types.ChatResponse, partial_types.ToolCall]], Union[types.ChatResponse, types.ToolCall]]:
      options: BamlCallOptions = {**self.__baml_options, **(baml_options or {})}
      __tb__ = options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb # type: ignore (we know how to use this private attribute)
      ...
      return baml_py.BamlStream[Optional[Union[partial_types.ChatResponse, partial_types.ToolCall]], Union[types.ChatResponse, types.ToolCall]](
        raw,
