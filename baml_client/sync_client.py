...
class BamlSyncClient:
    ...
    def ChatWithLLM(
        self,
        messages: List[types.ChatMessage],available_tools: List[types.MCPTool],
        baml_options: BamlCallOptions = {},
    ) -> Union[types.ChatResponse, types.ToolCall]:
      ...
      return cast(Union[types.ChatResponse, types.ToolCall], raw.cast_to(types, types, partial_types, False))
...
class BamlStreamClient:
    ...
    def ChatWithLLM(
        ...
        messages: List[types.ChatMessage],available_tools: List[types.MCPTool],
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[Optional[Union[partial_types.ChatResponse, partial_types.ToolCall]], Union[types.ChatResponse, types.ToolCall]]:
      options: BamlCallOptions = {**self.__baml_options, **(baml_options or {})}
      __tb__ = options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb # type: ignore (we know how to use this private attribute)
      ...
      return baml_py.BamlSyncStream[Optional[Union[partial_types.ChatResponse, partial_types.ToolCall]], Union[types.ChatResponse, types.ToolCall]](
        raw,
        lambda x: cast(Optional[Union[partial_types.ChatResponse, partial_types.ToolCall]], x.cast_to(types, types, partial_types, True)),
        lambda x: cast(Union[types.ChatResponse, types.ToolCall], x.cast_to(types, types, partial_types, False)),
        self.__ctx_manager.get(),
      )
